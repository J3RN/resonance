...
use crate::util::{self, player, seconds_to_string_longform, win};
...
impl QueueSidebar {
    ...
    fn initialize(&self) {
        ...
        imp.edit_button
            .connect_toggled(clone!(@strong self as this => move |_button| {
    ...
    fn update_current_position_playing_icon(&self, position: u64) {
        ...
        child
            ...
            .is_playing(true);
        imp.list_box
            .select_row(child.clone().downcast_ref::<QueueTrack>());
    }
